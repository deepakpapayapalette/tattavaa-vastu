            ...
            <div className="col-lg-6 col-12">
              <div className="flex justify-between flex-col h-100">
                ...
                <div className="flex justify-between  gap-3 ">
                  <span> 
                    <NavLink to="/order-page" className="first-btn text-center px-4"> 	Order Now </NavLink>
                  </span>
                  <span className='grid place-items-center'>

                    <NavLink className="second-btn text-center  text-lora" to="/shop">Back to Shop</NavLink>
                  </span>
                </div>
              </div>
            </div>
